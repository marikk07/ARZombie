...
extern "C"  void UnityARHitTestExample_Update_m1266118659 (UnityARHitTestExample_t146867607 * __this, const MethodInfo* method)
{
	...
	}
	{
		...
		NullCheck(L_9);
		Vector3_t2243707580  L_12 = Camera_ScreenToViewportPoint_m2666228286(L_9, L_11, /*hidden argument*/NULL);
		V_1 = L_12;
		...
		ARPoint_t3436811567  L_15 = V_3;
		V_2 = L_15;
		ARHitTestResultTypeU5BU5D_t1303085420* L_16 = ((ARHitTestResultTypeU5BU5D_t1303085420*)SZArrayNew(ARHitTestResultTypeU5BU5D_t1303085420_il2cpp_TypeInfo_var, (uint32_t)3));
		RuntimeHelpers_InitializeArray_m3920580167(NULL /*static, unused*/, (Il2CppArray *)(Il2CppArray *)L_16, LoadFieldToken(U3CPrivateImplementationDetailsU3E_t1486305142____U24fieldU2D8E7629AD5AF686202B8CB7C014505C432FFE31E6_0_FieldInfo_var), /*hidden argument*/NULL);
		V_4 = L_16;
		ARHitTestResultTypeU5BU5D_t1303085420* L_17 = V_4;
		V_6 = L_17;
		V_7 = 0;
		goto IL_00c9;
	}
...
IL_00ad:
	{
		ARHitTestResultTypeU5BU5D_t1303085420* L_18 = V_6;
		int32_t L_19 = V_7;
		NullCheck(L_18);
		int32_t L_20 = L_19;
		int64_t L_21 = (L_18)->GetAt(static_cast<il2cpp_array_size_t>(L_20));
		V_5 = L_21;
		ARPoint_t3436811567  L_22 = V_2;
		int64_t L_23 = V_5;
		bool L_24 = UnityARHitTestExample_HitTestWithResultType_m996939112(__this, L_22, L_23, /*hidden argument*/NULL);
		if (!L_24)
		{
			goto IL_00c3;
		}
...
IL_00c9:
	{
		int32_t L_26 = V_7;
		ARHitTestResultTypeU5BU5D_t1303085420* L_27 = V_6;
		NullCheck(L_27);
