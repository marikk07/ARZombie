...
extern "C"  void ZombieControl_Update_m2613536659 (ZombieControl_t4200399727 * __this, const MethodInfo* method)
{
	...
	memset(&V_0, 0, sizeof(V_0));
	{
		bool L_0 = __this->get_shouldMove_2();
		if (!L_0)
		{
			goto IL_0043;
		}
	}
	{
		...
		Vector3_t2243707580  L_8 = Vector3_op_Multiply_m1351554733(NULL /*static, unused*/, L_4, ((float)((float)L_7*(float)(0.05f))), /*hidden argument*/NULL);
		NullCheck(L_1);
		Transform_Translate_m3316827744(L_1, L_8, /*hidden argument*/NULL);
	}
...
{
	{
		Animation_t2068071072 * L_0 = __this->get_animation_3();
		NullCheck(L_0);
		bool L_1 = Animation_get_isPlaying_m729836826(L_0, /*hidden argument*/NULL);
		if (L_1)
		{
			goto IL_0028;
		}
	...
	{
		Animation_t2068071072 * L_2 = __this->get_animation_3();
		NullCheck(L_2);
		Animation_Play_m185747875(L_2, /*hidden argument*/NULL);
		__this->set_shouldMove_2((bool)1);
		goto IL_003a;
	}

IL_0028:
	{
		Animation_t2068071072 * L_3 = __this->get_animation_3();
		NullCheck(L_3);
		Animation_Stop_m1726655695(L_3, /*hidden argument*/NULL);
		__this->set_shouldMove_2((bool)0);
	}
...
extern "C"  void ZombieControl_LookAt_m1405337210 (ZombieControl_t4200399727 * __this, const MethodInfo* method)
{
	...
	memset(&V_0, 0, sizeof(V_0));
	{
		...
		NullCheck(L_0);
		Transform_LookAt_m3314153180(L_0, L_3, /*hidden argument*/NULL);
		...
		NullCheck(L_4);
		Transform_set_eulerAngles_m2881310872(L_4, L_8, /*hidden argument*/NULL);
		return;
	}
}
